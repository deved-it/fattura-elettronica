...
class DatiConvenzione implements XmlSerializableInterface, \Countable, \Iterator
{
    ...
    {
        return $this->datiConvenzione[$this->currentIndex];
    }
    ...
    {
        return isset($this->datiConvenzione[$this->currentIndex]);
    }
    ...
    {
        return count($this->datiConvenzione);
    }
